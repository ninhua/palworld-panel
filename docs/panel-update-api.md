...
```json
{
  ...
  "data": {
    ...
    "latest_version": "v1.3.0-custom.0.8.26",
    "release_tag": "v1.3.0-custom.0.8.26",
    "release_url": "https://github.com/ninhua/palworld-panel/releases/tag/v1.3.0-custom.0.8.26",
    "update_available": true,
    "checked_at": "2026-07-29T04:00:00Z",
    "message": "发现面板新版本 v1.3.0-custom.0.8.26"
  }
}
```
...
```text
palpanel_v1.3.0-custom.0.8.26_linux_amd64.tar.gz
palpanel_v1.3.0-custom.0.8.26_windows_amd64.zip
```
