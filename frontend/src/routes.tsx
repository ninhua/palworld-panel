...
export const appRoutes: AppRoute[] = [
  ...
  { id: 'economy', path: '/economy', title: '积分系统', navLabel: '积分系统', navGroup: 'world', icon: <Coins size={18} />, element: <Economy /> },
  ...
  { id: 'live-map', path: '/map', title: '世界地图', navLabel: '世界地图', titleKey: 'route.liveMap', navGroup: 'world', icon: <MapIcon size={18} />, element: <LiveMap /> },
