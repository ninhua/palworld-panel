...
func normalizePatchFeatures(features []string) []string {
	...
	for _, feature := range features {
		...
		if feature == "" { continue }
		if _, exists := seen[feature]; exists { continue }
		seen[feature] = struct{}{}
